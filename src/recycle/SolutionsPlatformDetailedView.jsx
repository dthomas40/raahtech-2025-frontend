...
// import Ping from '../../../assets/PlatformSectionImages/PlatformSectionGraphic1.png';
// import Okta from '../../../assets/PlatformSectionImages/PlatformSectionGraphic2.png';
// import Delinea from '../../../assets/PlatformSectionImages/PlatformSectionGraphic3.png';
// import CyberArk from '../../../assets/PlatformSectionImages/PlatformSectionGraphic4.png';
// import Microsoft from '../../../assets/PlatformSectionImages/PlatformSectionGraphic5.png';
// import WS02 from '../../../assets/PlatformSectionImages/PlatformSectionGraphic6.png';
// import Omada from '../../../assets/PlatformSectionImages/PlatformSectionGraphic7.png';
// import RadiantLogic from '../../../assets/PlatformSectionImages/PlatformSectionGraphic8.png';
// import Gigya from '../../../assets/PlatformSectionImages/PlatformSectionGraphic9.png';
// import ServiceNow from '../../../assets/PlatformSectionImages/PlatformSectionGraphic10.png';
// import Saviynt from '../../../assets/PlatformSectionImages/PlatformSectionGraphic11.png';
import React from 'react'
import { useState, useEffect } from 'react';
import { useLocation, useNavigate } from 'react-router-dom';
import './SolutionsPlatformDetailedView.css';
        ...
        content: (
            <div className="SolutionsPlatformDetailedViewContentWrapper">
                ...
                <ul className="SolutionsPlatformDetailedViewList">
                    <li className="SolutionsPlatformDetailedViewListItem">
                        <a
                            href="https://docs.cyberark.com/Product-Doc/OnlineHelp/PAS/Latest/en/Content/Home-PAS.htm"
                            target="_blank"
                            rel="noopener noreferrer"
                        >
        ...
        content: (
            <div className="SolutionsPlatformDetailedViewContentWrapper">
                ...
                <ul className="SolutionsPlatformDetailedViewList">
                    ...
                    <li className="SolutionsPlatformDetailedViewListItem">
                        <a
                            href="https://www.omada.net/en-us/resources"
                            target="_blank"
                            rel="noopener noreferrer"
                        >
                            Omada Resources
                    ...
                    <li className="SolutionsPlatformDetailedViewListItem">
                        <a
                            href="https://www.omada.net/en-us/company/contact"
                            target="_blank"
                            rel="noopener noreferrer"
                        >
                            Omada Support
        ...
        content: (
            <div className="SolutionsPlatformDetailedViewContentWrapper">
                ...
                <ul className="SolutionsPlatformDetailedViewList">
                    <li className="SolutionsPlatformDetailedViewListItem">
                        <a
                            href="https://www.sap.com/products/customer-data-cloud.html"
                            target="_blank"
                            rel="noopener noreferrer"
                        >
                    ...
                    <li className="SolutionsPlatformDetailedViewListItem">
                        <a
                            href="https://www.sap.com/training/cloud/customer-data-cloud.html"
                            target="_blank"
                            rel="noopener noreferrer"
                        >
        ...
        content: (
            <div className="SolutionsPlatformDetailedViewContentWrapper">
                ...
                <ul className="SolutionsPlatformDetailedViewList">
                    ...
                    <li className="SolutionsPlatformDetailedViewListItem">
                        <a
                            href="https://docs.servicenow.com/bundle/utah-platform-user-interface/page/build/service-portal/concept/Service-Portal.html"
                            target="_blank"
                            rel="noopener noreferrer"
                        >
